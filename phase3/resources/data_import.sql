...
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Excel Peer Support Network', 'senior students only', 'none', 'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('ESW Hydroponics/Urban Farming Project', 'junior students only', 'none', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Excel Current Events', 'senior students only', 'COC students only', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Shakespeare in Prison Project', 'none', 'College of Design students only', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Know Your Water Project', 'senior students only', 'none', 'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Epic Intentions', 'none', 'none', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Acromantula', 'senior students only',  'none', 'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Basilisk', 'junior students only',  'none',  'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Centaur', 'senior students only', 'none', 'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Dragon', 'senior students only', 'none', 'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Ghoul', 'junior students only', 'none', 'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Leprechaun', 'junior students only', 'none', 'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Merperson', 'junior students only', 'none', 'CS students only');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Three-headed Dog', 'none', 'none', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Toad', 'none', 'none', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Troll', 'none', 'none', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Thestral', 'none', 'none', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Hippogriff', 'none', 'none', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Owl', 'none', 'none', 'none');
INSERT INTO project_requirements (pName, pYearRequirement, pDeptRequirement, pMajorRequirement) VALUES ('Unicorn', 'none', 'none', 'none');
